...
namespace AntMe.Spieler.DotNetBS1
{
	...
	public class MeineAmeise : Basisameise
	{
		...
		/// Ameisen.</param>
        // public MeineAmeise(Volk volk, Dictionary<string, int> anzahl)
        //	: base(volk, anzahl) { }
...
//
//       public static Ameisentypen GetType(Basisameise ameise)
//       {
//           if ((ameise as MeineAmeise).Typ == Obstameise)
//               return Ameisentypen.Obst;
//           else if ((ameise as MeineAmeise).Typ == Zuckerameise)
